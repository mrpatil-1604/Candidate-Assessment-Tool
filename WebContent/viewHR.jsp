      ...
      <div class="card-content">
        ...
        <table>
          ...
          <tr>
            ...
            <td data-label="Email"><%=rs.getString(3)%></td>
            <td data-label="Mobile no." ><%=rs.getString(4)%></td>
            <td data-label="Password"><%=rs.getString(5)%></d>
            <td data-label="Designation"><%=rs.getString(6)%></d>
            <td><a href ="deleteHr.jsp?Id=<%=rs.getInt(1) %>">Delete</a></d>
            </td>
          </tr>
          </tbody>
          <%} %>
